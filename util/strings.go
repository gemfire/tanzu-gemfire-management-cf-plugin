...
const (
	IncorrectUserInputMessage string = `Your request was denied.
	...
	ProvidedUsernameAndNotPassword string = `You did not specify your password.
	...
	For help see: cf pcc --help
	`
	ProvidedPasswordAndNotUsername string = `You did not specify your username.
	Please enter username and password:
	...
	For help see: cf pcc --help
	`
	NeedToProvideUsernamePassWordMessage string = `You need to provide your username and password.
